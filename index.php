            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                      ...
                      <?php endif; ?>
                      <li class="nav-item"><a class="nav-link js-scroll-trigger" href="grid-gallery.html?page=home" >Gallery</a></li>
    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 - Online Food Ordering System MP-2 </div></div>
        </footer>
